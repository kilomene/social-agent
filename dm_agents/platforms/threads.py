"""Threads DM adapter: stub (not configured).

No Threads account is registered in this brain yet and no live-browser
...
REASON = ("threads DM agent not configured: no account registered and no "
